...
class NewPassChange extends StatefulWidget{
  NewPassChange(this.email);
  String? email;

  @override
  _NewPassChangeState createState() => _NewPassChangeState();

}

class _NewPassChangeState extends State<NewPassChange>{

  NewChangePassModel? _newChangePassModel;
                     ...
                     child: Container(
                       child: Column(
                         ...
                         children: [
                           ...
                           Container(
                               margin: EdgeInsets.only(left: 15.0, top: 15.0),
                               child: Text("Your New Password Must Be Diffrent From \n Previously Used Password",
